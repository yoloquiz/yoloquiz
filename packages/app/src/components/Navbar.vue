<template>
  <nav
    class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-gray-900"
  >
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
      <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
        <a
          ...
          href="https://www.yolotrip.fr/learning-lab/tailwind-starter-kit#/presentation"
          >YoloQuiz</a
        ><button
        ...
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            <a
              ...
              href="https://www.yolotrip.fr/learning-lab/tailwind-starter-kit#/login"
